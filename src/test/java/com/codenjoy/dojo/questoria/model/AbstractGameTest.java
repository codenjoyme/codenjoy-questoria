...
import com.codenjoy.dojo.questoria.services.Event;
...
public abstract class AbstractGameTest
        extends AbstractBaseGameTest<Player, Questoria, GameSettings, Level, Hero> {
    ...
    @Override
    protected TriFunction<Dice, Level, GameSettings, Questoria> createField() {
        return Questoria::new;
    }
